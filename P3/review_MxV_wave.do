...
add wave -noupdate -expand -group Matriz_x_Vector_module -radix decimal /TB_Matriz_x_Vector/DUV/N_input
...
add wave -noupdate -expand -group Matriz_x_Vector_module /TB_Matriz_x_Vector/DUV/flag_cmd
...
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/rst
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/enb
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/sync_rst_enb
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/N_input
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/Flag
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/Counting
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/MaxValue_Bit
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/Counting_logic
add wave -noupdate -expand -group {Contador SM} /TB_Matriz_x_Vector/DUV/contador_SM/Maximum_Value
add wave -noupdate -expand -group {Demux comandos} /TB_Matriz_x_Vector/DUV/Demux_Comandos/Selector
add wave -noupdate -expand -group {Demux comandos} -radix hexadecimal /TB_Matriz_x_Vector/DUV/Demux_Comandos/Data_input
add wave -noupdate -expand -group {Demux comandos} /TB_Matriz_x_Vector/DUV/Demux_Comandos/Data_out_0
add wave -noupdate -expand -group {Demux comandos} /TB_Matriz_x_Vector/DUV/Demux_Comandos/Data_out_1
add wave -noupdate -expand -group {Demux comandos} /TB_Matriz_x_Vector/DUV/Demux_Comandos/Data_out_2
add wave -noupdate -expand -group {Demux comandos} /TB_Matriz_x_Vector/DUV/Demux_Comandos/Data_out_3
...
add wave -noupdate -group {Comando 3} /TB_Matriz_x_Vector/DUV/CMD3_State_Machine/N_input
...
add wave -noupdate -group {Comando 4} /TB_Matriz_x_Vector/DUV/CMD4_State_Machine/N_input
